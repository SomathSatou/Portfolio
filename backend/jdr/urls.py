...
urlpatterns = [
    ...
    path('passive-skills/', PassiveSkillListCreateView.as_view(), name='passive-skills'),
    path('passive-skills/<int:pk>/', PassiveSkillDetailView.as_view(), name='passive-skill-detail'),
    ...
    path('garden/plots/<int:pk>/fertilize/', GardenPlotFertilizeView.as_view(), name='garden-plot-fertilize'),
    path('garden/plots/<int:pk>/unlock/', GardenPlotUnlockView.as_view(), name='garden-plot-unlock'),
    ...
    path('garden/recipes/', GardenRecipesView.as_view(), name='garden-recipes'),
    path('garden/mutation-logs/', GardenMutationLogsView.as_view(), name='garden-mutation-logs'),
    # Runes
    path('runes/templates/<int:pk>/favorite/', RuneFavoriteToggleView.as_view(), name='rune-template-favorite'),
    ...
    path('runes/drawings/<int:pk>/annotations/', RuneDrawingAnnotationsUpdateView.as_view(), name='rune-drawing-annotations'),
