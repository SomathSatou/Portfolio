  ...
  return (
    <div className="h-screen bg-gray-50 dark:bg-gray-950 flex overflow-hidden">
      ...
      >
        ...
        <div className="shrink-0 px-3 py-4 border-t border-gray-200 dark:border-gray-800">
          <a
            href="#/"
      ...
      <div className="flex-1 flex flex-col min-w-0 overflow-hidden">
        {/* Top header */}
        <header className="z-20 h-16 shrink-0 bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-800 flex items-center justify-between px-4 lg:px-6">
          <div className="flex items-center gap-3">
            ...
            <a
              href="#/"
              className="lg:hidden text-xs text-gray-500 dark:text-gray-500 hover:text-gray-700 dark:hover:text-gray-300 no-underline"
            >
              ← Retour au portfolio
            </a>
          </div>
